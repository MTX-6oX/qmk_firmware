...
void td_esc_lthree_tap(qk_tap_dance_state_t *state, void *user_data)
{
...
esctap_state.state = cur_dance(state);
  ...
  switch (esctap_state.state) {
    ...
    case DOUBLE_TAP: set_oneshot_layer(3, ONESHOT_START); break;
...
qk_tap_dance_action_t tap_dance_actions[] = {
    [TD_ESC_LTHREE] = ACTION_TAP_DANCE_FN_ADVANCED(td_esc_lthree_tap, td_esc_lthree_finished, td_esc_lthree_reset)
...
[WIN_BASE] = LAYOUT_ansi_87(
     TD(TD_ESC_LTHREE),   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,             KC_PSCR,   KC_CTANA, KC_PASTE,
     ...
     KC_LCTL,  KC_LGUI,  KC_LALT,                                LT(3, KC_SPC),                                 KC_RALT,  KC_RGUI, MO(WIN_FN),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
